...
function M.load_language_module(language_name, base_path, config)
  ...
  utils.log(string.format("Attempting to load language module '%s' from path '%s'", language_name, module_path), "info")
...
function M.init(config)
  ...
  utils.log(string.format("Language discovery complete: %d discovered, %d registered, %d healthy", 
           stats.discovered_count, stats.registered_count, stats.healthy_count), "info")
end
