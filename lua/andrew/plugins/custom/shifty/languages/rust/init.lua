...
function M.validate_rust_semantics(code)
  ...
  for i, line in ipairs(lines) do
    ...
    if trimmed ~= "" and not trimmed:match("^//") and not trimmed:match("^///") and not trimmed:match("^use") and not trimmed:match("^mod") then
  ...
  if code:match("Result<") and not code:match("%?%.") and not code:match("unwrap%(") and not code:match("expect%(") then
  ...
  if code:match("Option<") and not code:match("%?%.") and not code:match("unwrap%(") and not code:match("expect%(") then
