...
function M.set_initial_content(buf)
  local lines = {
    "󰢱 Shifty - Lua HOT Compiler",
    "━━━━━━━━━━━━━━━━━━━━━━━━━━",
    "",
    "Ready to execute Lua code blocks!",
    "",
    "Usage:",
    "• Place cursor in a ```lua code block",
...
function M.update_output(win, result, block_identifier)
  ...
  table.insert(lines, "")
  table.insert(lines, "━━━━━━━━━━━━━━━━━━━━━━━━━━")
  table.insert(lines, "Place cursor in ```lua block and press " .. (config.get("keymaps.run") or "<leader>sr") .. " to execute")
