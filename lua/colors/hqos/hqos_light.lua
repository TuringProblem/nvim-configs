...
theme.set_highlights = function()
	...
	hl(0, "VertSplit", { fg = c._blue, bg = c.bg })
	hl(0, "CursorLine", { fg = c._light_blue, bg = c.bg, bold = true, italic = true })
	hl(0, "CursorColumn", { fg = c._light_blue, bg = c.cursorline })
	hl(0, "ColorColumn", { fg = "NONE", bg = c.cursorline })
	hl(0, "NormalFloat", { fg = c.fg, bg = c.alt_bg, blend = 20 })
	hl(0, "Visual", { fg = c.fg, bg = c._light_blue, bold = true })
	...
	hl(0, "Cursor", { fg = c._red, bg = c._red })
	...
	hl(0, "StatusLine", { fg = c.fg, bg = c._blue })
	hl(0, "StatusLineNC", { fg = c._red, bg = c.alt_bg })

	hl(0, "StatusLineTerm", { fg = c.fg, bg = c._green })
	hl(0, "StatusLineTermNC", { fg = c._red, bg = c.alt_bg })

	-- Code
	hl(0, "Comment", { fg = c._grey_dark, bg = "NONE", italic = true })
	hl(0, "Variable", { fg = c._light_blue, bg = "NONE" })
	hl(0, "String", { fg = c._green, bg = "NONE", bold = true })
	...
	hl(0, "TelescopePromptTitle", { fg = c._grey_dark, bg = "NONE" })
	hl(0, "TelescopePromptPrefix", { fg = c._blue, bg = "NONE" })
	hl(0, "TelescopeResultsTitle", { fg = c._grey_dark, bg = "NONE" })
	...
	hl(0, "markdownCode", { fg = c._orange, bg = "NONE" })
	hl(0, "markdownCodeBlock", { fg = c._orange, bg = "NONE" })
	hl(0, "markdownCodeDelimiter", { fg = c._orange, bg = "NONE" })
	...
	hl(0, "htmlH1", { fg = c._red, bg = "NONE" })
	hl(0, "htmlH2", { fg = c._red, bg = "NONE" })
	hl(0, "htmlH3", { fg = c._red, bg = "NONE" })
	hl(0, "htmlH4", { fg = c._red, bg = "NONE" })
	hl(0, "htmlH5", { fg = c._red, bg = "NONE" })
	hl(0, "htmlH6", { fg = c._red, bg = "NONE" })
