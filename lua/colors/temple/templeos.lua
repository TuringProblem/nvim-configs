local c = require("colors.temple.palette")
...
theme.set_highlights = function()
  ...
  hl(0, "Variable", { fg = c.fg, bg = "#000000" })
  ...
  hl(0, "Identifier", { fg = c.black, bg = "NONE" })
